...
written in the v0.1 dialect. ``load_config`` merges the given v0.1 documents and
converts the result to v0.2, mirroring what the ``muscle_manager`` CLI does in
``muscle3.muscle_manager.load_configuration``.
"""
