...
def test_increment_suffix():
  ...
  assert increment_suffix('imas:hdf5?path=my_string_1') == 'imas:hdf5?path=my_string_2'
  assert increment_suffix('imas:hdf5?path=my_string_99') == 'imas:hdf5?path=my_string_100'
  assert increment_suffix('imas:hdf5?path=my_string_09') == 'imas:hdf5?path=my_string_10'
  assert increment_suffix('imas:hdf5?path=my/string') == 'imas:hdf5?path=my/string_1'
  assert increment_suffix('imas:hdf5?path=my_1_string') == 'imas:hdf5?path=my_1_string_1'
  assert increment_suffix('imas:hdf5?path=my_1_string_2') == 'imas:hdf5?path=my_1_string_3'
  assert increment_suffix('imas:hdf5?path=9') == 'imas:hdf5?path=9_1'
  assert increment_suffix('imas:hdf5?path=_9') == 'imas:hdf5?path=_10'
  assert increment_suffix('imas:hdf5?path=my_string&hdf5_debug=true') == 'imas:hdf5?path=my_string_1&hdf5_debug=true'
  assert increment_suffix('imas:hdf5?path=my_string;hdf5_debug=true') == 'imas:hdf5?path=my_string_1&hdf5_debug=true'
...
def test_get_sink_db_entry(tmp_path, backend):
  ...
  legacy_uri = f"imas:{backend}?pulse=123;run=2;user={tmp_path};database=ITER;version=3"
